        ...
        <Rodal customStyles={customStyles} visible={visible} onClose={onClose}>
            <div className={css.container}>
                <div>
                    ...
                    <input type="text" className={css.input} value={title} placeholder='Add title..' onChange={(e) => setTitle(e.target.value)} />
                </div>

                <div>
                    <span className={css.label}>Detail</span>
                    <textArea
                        rows={10} className={css.input} value={detail} placeholder='Add the datails here...'
